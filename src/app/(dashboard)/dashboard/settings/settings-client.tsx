       ...
       >
        <div className="p-4 bg-blue-50 dark:bg-blue-900/10 rounded-lg border border-blue-100 dark:border-blue-900/20 mb-6">
         <p className="text-sm text-blue-800 dark:text-blue-300">
          <strong>Comment obtenir vos clés Stripe ?</strong><br />
          Rendez-vous sur <a href="https://dashboard.stripe.com/apikeys" target="_blank" rel="noopener noreferrer" className="underline">dashboard.stripe.com/apikeys</a> pour récupérer vos clés API.
         </p>
        </div>
        ...
        <div className="space-y-2">
         ...
         />
         <p className="text-xs text-muted-foreground">Commence par pk_test_ (test) ou pk_live_ (production)</p>
        </div>
        ...
        <div className="space-y-2">
         ...
         <Input
          ...
          className="font-mono text-sm"
         />
         <p className="text-xs text-muted-foreground">⚠️ Ne partagez jamais cette clé. Commence par sk_test_ ou sk_live_</p>
        </div>
